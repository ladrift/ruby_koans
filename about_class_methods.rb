...
class AboutClassMethods < Neo::Koan
  ...
  ## Answer: I prefer first way, because it looks like a function defination.
  ##      Instead, another way looks like class defination,
  ##      which can be misleading when someone read the code.
