...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    assert_equal "a", "abbcccddddeeeee"[/az*/]
    assert_equal "", "abbcccddddeeeee"[/z*/] # TRICKY

    # THINK ABOUT IT:
    #
    # When would * fail to match?
    ## Answer: If regex contains only one asterisk with one character,
    ##         it will not fail.
  end
  ...
  #
  # Why?
  ## Answer: "greedy" means a Regexp will match more characters as it can.

  # ------------------------------------------------------------------

  def test_the_left_most_match_wins
    assert_equal "a", "abbccc az"[/az*/] # TRICKY
  end
  ...
  ## Answer: character classs ([...]) means any character in the class can be matched.
  ##         alternation (|) means any matched string matched one alternative.
